...
export default {
	...
	computed: {
		...
		useDefaultCursor() {
			return contains(this.modifiers, 'blocked-minimum-nights') ||
				contains(this.modifiers, 'blocked-calendar') ||
				contains(this.modifiers, 'blocked-out-of-range');
		},
		selected() {
			return contains(this.modifiers, 'selected') ||
		...
		classObject() {
			...
			return {
				...
				CalendarDay__highlighted_calendar: contains(modifiers, 'highlighted-calendar'),
				CalendarDay__blocked_minimum_nights: contains(modifiers, 'blocked-minimum-nights'),
				...
				CalendarDay__blocked_out_of_range: contains(modifiers, 'blocked-out-of-range')
			};
		},
		formatDay() {
			return this.renderDay ? this.renderDay(this.day, this.modifiers) : this.day.format('D');
		}
	},
	methods: {
		onMouseEnter(e) {
